...
sleep 3
echo "Downloading preconfigured Box86..."
cd $HOME
wget -q --show-progress https://github.com/ShephardOS9/BoxWine/releases/download/Box86/box86.tar.xz

echo "Unpacking BoxWine archive..."
tar -xf box86.tar.xz
rm -f box86.tar.xz
fi
    sleep 3
